const GIFT_CATALOG = {
  ...
  gift_04: { label: 'Camisa do Santos para o noivo ir ver o Neymar', amount: 450 },
  gift_05: { label: 'Lanche do noivo', amount: 200 },
  gift_06: { label: 'Vaquinha para o ar condicionado', amount: 550 },
  gift_07: { label: 'Ração das dogs (Lisa e Cristal)', amount: 250 },
  ...
  gift_12: { label: 'Pilhas do controle do ar', amount: 450 },
  gift_13: { label: 'Havaianas da noiva', amount: 340 },
  gift_14: { label: 'Camisa do Santos para o noivo ir ver o Neymar', amount: 450 },
  ...
  gift_22: { label: 'Camisa do Santos para o noivo ir ver o Neymar', amount: 450 },
